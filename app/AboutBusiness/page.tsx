              ...
              <div className="grid grid-cols-3 gap-3 md:gap-4">
                ...
                >
                  {selectedType === "clients" && (
                    <div className="absolute -top-2 -right-2 bg-red-600 text-white rounded-full w-6 h-6 flex items-center justify-center border-2 border-white shadow-sm">
                      <svg
                        className="w-3 h-3"
                        fill="none"
                        stroke="currentColor"
                  ...
                  {selectedType === "clients" ? (
                    ...
                    <svg
                      className="w-7 h-7 md:w-8 md:h-8 mb-2 md:mb-3 text-gray-600"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
